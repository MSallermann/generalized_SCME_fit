...
if __name__ == "__main__":
    logging.basicConfig(filename="fit_scme_rpbe.log", level=logging.INFO)

    default_params = SCMEParams()

    path_to_scme_expansions = Path("./input/scme_expansions_RPBE.hdf5")
    parametrization_key = "component_RPBE_fullrange_reflect_8_12"
    ...
    ###### DIMER ######
    dimer_csv = Path("./rpbe_dimer_stretch.csv")
    ...
    # Give a very high weight to the points around the minimum
    ...
    cluster_csv = Path("./rpbe_small_clusters.csv")
